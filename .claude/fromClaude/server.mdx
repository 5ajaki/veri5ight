...
<Note>Make sure you pass in the absolute path to your server.</Note>
...
Make sure to run `xnpm run build` to build your server! This is a very important step in getting your server to connect.
